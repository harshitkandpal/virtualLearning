...
function Setting() {
    ...
    const addResourceLink = () => {
        ...
        axios.put(baseUrl + "addstudents/" + localStorage.getItem('userId'), item1)
    }
                            ...
                            <div style={{ width: "95%", minHeight: "10vh", backgroundColor: "white", display: "flex", borderRadius: 10, paddingTop: "10px", flexDirection: "column", overflowY: "auto", }}>
                                <div className='set-res1'   style={{ minHeight: "4vh", width: "100%", display: "flex", }}>
                                    ...
                                    {type === "teacher" ?
                                        ...
                                        {type === "teacher" ?
                                        <div className='lgnd1'  style={{ width: "30%", height: "40vh", display: "flex", flexDirection: "column", alignItems: "center" }}>
                                            <button onClick={() => setShow(6)} style={{ height: "40px", width: "80%", backgroundColor: "black", color: "white", border: "none", borderRadius: 10, marginLeft: "2%" }}>Add Resource Link</button>
                                            <div style={{ height: show === 6 ? "30vh" : "0px", width: "80%", backgroundColor: "lightgrey", transition: "0.5s", overflow: "hidden", display: "flex", flexDirection: "column", justifyContent: "space-evenly", alignItems: "center", borderRadius: 10, marginTop: 10 }}>
                                                <input onChange={(e) => setResource(e.target.value)} style={{ width: "95%", height: 40 }} placeholder='Resource Link' />

                                                <button onClick={() => addResourceLink()} className='btn btn-outline-success'>Update</button>
                                            </div>
