          ...
          <div style={{ width: "100%", height: "73vh", backgroundColor: "white", alignItems: "center", display: "flex", gap: "2%",flexWrap:"wrap" }}>
            ...
            ></VideoCallFrame> */}
              ...
              <div style={{ height: "40vh", width: "100%", backgroundColor: "lightgrey", display: "flex", flexDirection: "column", alignItems: "center", borderRadius: 10 }}><br/>
                ...
                <>
                <div style={{ height: "12vh", width: "100%", display: "flex" }}>
                  <div style={{ height: "20vh", width: "50%", display: "flex", flexDirection: "column", alignItems: "center" }}>
                    <select onChange={(e) => setMode(e.target.value)} style={{ height: 35, width: "70%", border: "none", borderRadius: 10, outline: "none" }}>
                  ...
                  <div style={{ height: "12vh", width: "50%", display: "flex", flexDirection: "column", alignItems: "center" }}>
                    <select onChange={(e) => setAmbience(e.target.value)} style={{ height: 35, width: "70%", border: "none", borderRadius: 10, outline: "none" }}>
