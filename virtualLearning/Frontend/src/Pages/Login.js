    ...
    if (email !== '' && password !== '' && email.includes('@') && email.includes('.com')) {
      ...
      axios.post(baseUrl + 'addstudents/login', item).then((res) => {
        if (res.data.msg === 'ok') {
          ...
          // We are displaying a success message using React Toastify
      ...
      <div style={{ width: '100%', minHeight: '100vh', display: 'flex', flexWrap: 'wrap' }}>
            ...
            >
              ...
              <input
                ...
                style={{
                  width: '90%',
                  height: 35,
                  border: validator === true && email === '' ? '1px solid red' : '1px solid lightgrey',
                }}
              />
              <label
                style={{
                  fontSize: 12,
                  color: 'red',
                  display: !email.includes('@') || !email.includes('.com') && validator ? 'block' : 'none',
                }}
              >
                *Invalid Email
              </label>
            ...
            >
              ...
              <input
                ...
                style={{
                  width: '90%',
                  height: 35,
                  border: validator === true && password === '' ? '1px solid red' : '1px solid lightgrey',
                }}
              />
            </div>
            <br />
            <br />
            <div style={{ display: 'flex', justifyContent: 'start', paddingLeft: '5%' }}>
              <button
                onClick={() => logincheck()}
                style={{
                  height: '40px',
        ...
        >
          <h2 style={{ fontFamily: 'Tilt Prism', textShadow: '5px 5px 10px orange' }}>
            <label style={{ fontSize: 67 }}>Teenteaching </label> <br /> VIRTUAL LEARNING PLATFORM
          </h2>
        </div>
      </div>
    </div>
